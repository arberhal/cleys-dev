<div class="mx-auto max-w-[1568px]">
    <div class="lg:mt-16 mt-16 mx-4 lg:mx-16">
        ...
        <h2 class="text-body font-bold pt-8">2. Kontaktinformationen</h2>
        <p class="text-body-sm pt-4">Bei Fragen oder Anliegen zum Schutz Ihrer Daten durch uns erreichen Sie uns jederzeit per E-Mail unter admin@cleys.ch. Verantwortlich für die Datenbearbeitungen, die über diese Website erfolgen, ist:</p>
        <p class="text-body-sm pt-4">cleys KLG<br>Industriestrasse 15<br>9015 St. Gallen<br>Schweiz</p>
        <p class="text-body-sm pt-4"><strong>Datenschutzverantwortliche Person:</strong><br>Lindrit Ahmetaj<br>admin@cleys.ch<br>+41 78 317 48 44</p>
        <h2 class="text-body font-bold pt-8">3. Allgemeine Grundsätze</h2>
        <h3 class="text-body font-bold pt-4">3.1 Welche Daten sammeln wir von Ihnen und von wem erhalten wir diese Daten</h3>
        <p class="text-body-sm pt-4">In erster Linie bearbeiten wir Personendaten, die Sie uns übermitteln oder die wir beim Betrieb unserer Website sammeln. Unter Umständen erhalten wir Personendaten über Sie auch von Dritten. Das können folgende Kategorien sein:</p>
        <ul class="text-body-sm pt-4">
        ...
        <h3 class="text-body font-bold pt-4">3.2 Unter welchen Voraussetzungen bearbeiten wir Ihre Daten?</h3>
        ...
        <h3 class="text-body font-bold pt-4">3.3 Wie können Sie Ihre Einwilligung widerrufen?</h3>
        <p class="text-body-sm pt-4">Haben Sie uns eine Einwilligung zur Bearbeitung Ihrer personenbezogenen Daten für bestimmte Zwecke erteilt, bearbeiten wir Ihre Daten im Rahmen dieser Einwilligung, soweit wir keinen anderen Rechtfertigungsgrund haben. Sie haben jederzeit die Möglichkeit, Ihre Einwilligung zu widerrufen indem Sie eine E-Mail an die im Impressum genannte Adresse schicken. Bereits erfolgte Datenverarbeitungen sind davon nicht betroffen.</p>
        <h3 class="text-body font-bold pt-4">3.4 In welchen Fällen können wir Ihre Daten an Dritte weitergeben?</h3>
        <h4 class="text-body font-bold pt-4">a. Grundsatz</h4>
        <p class="text-body-sm pt-4">Wir sind unter Umständen darauf angewiesen, die Dienste Dritter oder von verbundenen Unternehmen in Anspruch zu nehmen und diese mit der Verarbeitung Ihrer Daten zu beauftragen (sog. Auftragsverarbeiter). Kategorien der Empfänger sind namentlich:</p>
        <ul class="text-body-sm pt-4">
        ...
        <h3 class="text-body font-bold pt-4">3.7 Welche Rechte haben Sie?</h3>
        <h4 class="text-body font-bold pt-4">a. Auskunftsrecht</h4>
        <p class="text-body-sm pt-4">Sie können jederzeit eine Auskunft über die von uns über Sie gespeicherten Daten verlangen. Wir bitten Sie, Ihr Auskunftsgesuch zusammen mit einem Identitätsnachweis an admin@cleys.ch zu senden. Sie haben ausserdem das Recht, Ihre Daten in einem gängigen Dateiformat zu erhalten, wenn wir Ihre Daten automatisiert bearbeiten, und wenn:</p>
        <ul class="text-body-sm pt-4">
        ...
        <p class="text-body-sm pt-4">Wir können die Auskunft bzw. Datenherausgabe einschränken oder verweigern, wenn dies unseren gesetzlichen Verpflichtungen, berechtigten eigenen oder öffentlichen Interessen oder Interessen einer Drittperson entgegensteht. Die Bearbeitung Ihres Gesuchs unterliegt der gesetzlichen Bearbeitungsfrist von 30 Tagen. Diese Frist dürfen wir jedoch aufgrund von hohem Anfragevolumen, aus rechtlichen oder technischen Gründen oder weil wir nähere Angaben von Ihnen benötigen, verlängern. Sie werden über die Fristverlängerung rechtzeitig mindestens in Textform informiert.</p>
        <h4 class="text-body font-bold pt-4">b. Löschung und Berichtigung</h4>
        <p class="text-body-sm pt-4">Sie haben jederzeit die Möglichkeit, die Löschung oder Berichtigung Ihrer Daten zu verlangen. Wir können das Gesuch abweisen, wenn gesetzliche Vorschriften uns zur längeren bzw. unveränderten Aufbewahrung verpflichten oder ein Erlaubnistatbestand Ihrem Gesuch entgegensteht. Bitte beachten Sie, dass die Ausübung Ihrer Rechte unter Umständen im Konflikt mit vertraglichen Abmachungen stehen und entsprechende Auswirkungen auf die Vertragsdurchführung haben kann (z.B. vorzeitige Vertragsauflösung oder Kostenfolgen).</p>
        <h4 class="text-body font-bold pt-4">c. Rechtsweg</h4>
        <p class="text-body-sm pt-4">Sind Sie von der Bearbeitung personenbezogener Daten betroffen, haben Sie das Recht, Ihre Rechte gerichtlich durchzusetzen oder bei der zuständigen Aufsichtsbehörde eine Meldung einzureichen. Die zuständige Aufsichtsbehörde in der Schweiz ist der Eidgenössische Datenschutz- und Öffentlichkeitsbeauftragte: https://www.edoeb.admin.ch</p>
        <h3 class="text-body font-bold pt-4">3.8 Änderungen an der Datenschutzerklärung</h3>
        <p class="text-body-sm pt-4">Wir können diese Datenschutzerklärung jederzeit ändern. Die Änderungen werden auf veröffentlicht, Sie werden nicht gesondert darüber informiert.</p>
        <h2 class="text-body font-bold pt-8">4. Einzelne Datenverarbeitungsvorgänge</h2>
        <h3 class="text-body font-bold pt-4">4.1 Bereitstellen der Webseite und Erstellung von Logfiles</h3>
        <h4 class="text-body font-bold pt-4">Welche Informationen erhalten wir und wie nutzen wir sie?</h4>
        <p class="text-body-sm pt-4">Indem Sie besuchen, werden auf unseren Servern oder auf Servern von Dienstleistungen und Produkten, die wir beziehen und / oder installiert haben, bestimmte Daten automatisch zu Zwecken der Systemadministration, für statistische oder für Sicherungszwecke oder für Trackingzwecke gespeichert. Es handelt sich dabei um:</p>
        <ul class="text-body-sm pt-4">
        ...
        <h4 class="text-body font-bold pt-4">Weshalb dürfen wir diese Daten bearbeiten?</h4>
        <p class="text-body-sm pt-4">Diese Daten können keiner bestimmten Person zugeordnet werden und es findet keine Zusammenführung dieser Daten mit anderen Datenquellen statt. Die Speicherung der Logfiles erfolgt, um die Funktionsfähigkeit der Webseite zu garantieren und zur Sicherstellung der Sicherheit unserer informationstechnischen Systeme. Hierin besteht unser berechtigtes Interesse.</p>
        <h4 class="text-body font-bold pt-4">Wie können Sie die Datenerfassung verhindern?</h4>
        <p class="text-body-sm pt-4">Die Daten werden nur solange gespeichert, wie dies zur Erreichung des Zweckes Ihrer Erhebung notwendig ist. Dementsprechend werden die Daten nach Beendigung jeder Sitzung gelöscht. Die Speicherung der Logfiles ist für den Betrieb der Webseite zwingend notwendig, Sie haben daher keine Möglichkeit dagegen Widerspruch zu erheben.</p>
        <!-- Weitere Inhalte der Datenschutzerklärung hier, entsprechend formatiert -->
        <p class="text-body-sm pt-4"><strong>Quelle:</strong> Brainbox Solutions</p>
    </div>
</div>
