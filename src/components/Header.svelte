<header class="bg-black">
    <div class="container mx-auto max-w-[1280px] h-[100px] grid grid-cols-[1fr_auto_1fr] items-center">
        <div class="logo">
        ...
        <nav class="justify-self-center">
            <ul class="flex text-[18px] space-x-[45px] border-[1px] border-white p-[10px] rounded-full text-white">
        ...
        <div class="erstberatung justify-self-end">
            <button class="text-white">hallo</button>
        </div>
    </div>
</header>